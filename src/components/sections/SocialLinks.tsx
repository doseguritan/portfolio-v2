import LinkedinLogo from "@/components/assets/linkedinLogo.webp";
import GithubLogo from "@/components/assets/githubLogo.webp";
...
function SocialLinks() {
  const socialLinks = [
    {
      name: "LinkedIn",
      username: "@daryl-seguritan-4797a358",
      src: LinkedinLogo.src,
      alt: "LinkedIn",
      href: "https://www.linkedin.com/in/daryl-seguritan-4797a358/",
    },
    {
      name: "GitHub",
      username: "@doseguritan",
      src: GithubLogo.src,
      alt: "GitHub",
      href: "https://github.com/doseguritan",
    },
  ];
  return (
