  ...
  return (
    <section className='relative h-fit border-x full-line-bottom p-4'>
         <div
              ...
              />
        <p className="mb-1 text-center font-mono text-sm text-balance text-muted-foreground">Built with <a className="font-semibold underline" href="https://payloadcms.com/" target="_blank" rel="noopener">PayloadCMS</a>.</p>
        <p className=" text-center font-mono text-sm text-balance text-muted-foreground">Design by <a className="font-semibold underline" href="https://mdtaquiimam.vercel.app/" target="_blank" rel="noopener">Md Taqui Imam</a>. The source code is available on {" "}<a className="font-semibold underline" href="https://github.com/taqui-786/Taqui" target="_blank" rel="noopener">GitHub</a>.</p>
    </section>
  )
}
