...
import MyImage from "@/components/assets/myImage.jpg";
...
function ProfileSection() {
  const flipSentences = [
    ...
    "API and microservices engineer with strong frontend/backend experience.",
    "Building production-ready applications across the full stack.",
  ];
