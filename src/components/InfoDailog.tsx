        ...
        <div className="space-y-4 font-mono">
          ...
          <div className="space-y-3">
            ...
            <Button variant="outline" className="w-full justify-start" asChild>
              <a href="https://github.com/doseguritan/portfolio" target="_blank" rel="noopener noreferrer">
          ...
          {/* Tech Stack Info */}
          <div className="pt-2">
            <p className="text-xs text-muted-foreground text-center">Built with PayloadCMS • Tailwind CSS • TypeScript</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
